...
import { generateOptionPreview } from "@/lib/avatar/categories/optionPreview";
import { getCachedSprite, setCachedSprite, generateSpriteKey } from "@/lib/avatar/categories/spriteCache";
