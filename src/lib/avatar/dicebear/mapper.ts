...
// Additional skin tone mappings for new presets
SKIN_PRESET_TO_HEX['deep-brown'] = normalizeHexColor(SKIN_TONE_COLORS['deep-brown'] || '#614335', DEFAULT_SKIN_COLOR);
SKIN_PRESET_TO_HEX['golden'] = normalizeHexColor(SKIN_TONE_COLORS['golden'] || '#F8D25C', DEFAULT_SKIN_COLOR);
...
// Additional hair color mappings for new presets
HAIR_PRESET_TO_HEX['auburn'] = normalizeHexColor(HAIR_COLOR_VALUES['auburn'] || '#A55728', DEFAULT_HAIR_COLOR);
HAIR_PRESET_TO_HEX['platinum'] = normalizeHexColor(HAIR_COLOR_VALUES['platinum'] || '#E8E1E1', DEFAULT_HAIR_COLOR);
HAIR_PRESET_TO_HEX['dark-brown'] = normalizeHexColor(HAIR_COLOR_VALUES['dark-brown'] || '#2C1B18', DEFAULT_HAIR_COLOR);
HAIR_PRESET_TO_HEX['light-brown'] = normalizeHexColor(HAIR_COLOR_VALUES['light-brown'] || '#B58143', DEFAULT_HAIR_COLOR);
...
export function avatarConfigToDiceBearOptions(
  ...
  const options: Options = {
    ...
    clothingGraphic: clothingGraphic ? [clothingGraphic] : undefined,
