 ...
 * 
 * @module avatar/categories/optionPreview
 */

import { AvatarConfig, createDefaultAvatarConfig } from '../config';
import { generateAvatarDataUri } from '../preview/dicebearAdapter';
import { SKIN_TONE_COLORS, HAIR_COLOR_VALUES } from './assets';
