                        ...
                        >
                          <div className="flex items-start gap-2">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="text-xs text-muted-foreground line-clamp-1">{pack.description}</div>
                              <div className="text-xs text-muted-foreground mt-1">{pack.wordCount} words</div>
                            </div>
                          </div>
                        </button>
                      ))}
