          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription className="space-y-3 pt-4">
                ...
                <p className="text-sm">
                  <span className="inline-block w-3 h-3 rounded-full mr-2 bg-emerald-500" />
                  Rank 2-10 = Excellent
                </p>
                <p className="text-sm">
                ...
                <p className="text-sm">
                  <span className="inline-block w-3 h-3 rounded-full mr-2 bg-orange-500" />
                  Rank 51-100 = Good
                </p>
                <p className="text-sm">
                  <span className="inline-block w-3 h-3 rounded-full mr-2 bg-blue-500" />
                  Rank 100+ = Cold
                </p>
              </DialogDescription>
            </DialogHeader>
