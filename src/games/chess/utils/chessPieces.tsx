...
export const BlackKing = ({ size = 60, className }: PieceProps) => (
  <svg width={size} height={size} viewBox="0 0 45 45" className={className} style={{ display: "block" }}>
    <g fill="none" fillRule="evenodd" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M20 8h5" strokeLinejoin="miter"/>
      <path d="M32 29.5s8.5-4 6.03-9.65C34.15 14 25 18 22.5 24.5l.01 2.1-.01-2.1C20 18 10.85 14 6.97 19.85 4.5 25.5 13 29.5 13 29.5" stroke="#fff"/>
      <path d="M11.5 30c5.5-3 14.5-3 20 0M12 33.5c6-3 15-3 21 0" stroke="#fff"/>
    </g>
  </svg>
);
...
export const BlackBishop = ({ size = 60, className }: PieceProps) => (
  <svg width={size} height={size} viewBox="0 0 45 45" className={className} style={{ display: "block" }}>
    <g fill="none" fillRule="evenodd" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M17.5 11h10M15 14.5h15" strokeLinejoin="miter" stroke="#fff"/>
    </g>
  </svg>
);
